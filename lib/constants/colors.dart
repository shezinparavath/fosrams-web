...
class AppColors {
  ...
  static const tealClr = Color(0xff7AC6BF);
  static const blueColor = Color(0xff2f5ac8);
  static const darkBlue = Color(0xff343C6A);
  static const darkGreyColor = Color(0xff787276);
  static const greyedOutClr = Color(0xffF5F7FA);
  ...
  static const backGroundClr = Color(0xffF1F0FA);
